...
| 2026-05-24 | Added `^POI` after `^XA` in renderMerchandiseTag() (tagPrinter.js) to test hardware 180° flip — item_id at hole end, DataMatrix at far end. Labelary ignores ^POI; physical print result pending next session. If iF4 also ignores it, will do coordinate-transform approach instead. |
