...
- **Run in Supabase SQL editor:** `DROP TABLE IF EXISTS declined_items CASCADE;` then re-run `schema.sql` (or just the `declined_items` block) — reverts the column to `description` in the live DB.
